...
// parralell as tests in xml and here for two classes in different test tags in xml file we assigned two threads so it will run both classes in different tests in parallel 